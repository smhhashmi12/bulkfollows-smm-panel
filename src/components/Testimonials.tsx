...
const testimonials = [
  { name: 'Melissa Smith', avatar: 'https://i.pravatar.cc/150?u=melissa', metric: '321514 Followers' },
  { name: 'Michael John', avatar: 'https://i.pravatar.cc/150?u=michael', metric: '50M Subscribers' },
  { name: 'Isabella', avatar: 'https://i.pravatar.cc/150?u=isabella', metric: '132512 Listeners' },
];
          ...
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-brand-container border border-brand-border rounded-xl p-4 flex items-center justify-between shadow-lg backdrop-blur-sm">
              <div className="flex items-center gap-4">
                <img src={testimonial.avatar} alt={testimonial.name} className="w-16 h-16 rounded-full border-2 border-brand-purple" />
                <div>
